...
import 'package:learning_ui_and_provider/main.dart';
...
class _FavouriteState extends State<Favourite> {
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      itemCount: AddedItemList.favouriteName.length,
      itemBuilder: (context, index) {
        return ListTile(
          leading: CircleAvatar(
            ...
            child: Text(
              AddedItemList.favouriteName[index].substring(0, 1).toUpperCase(),
              style: TextStyle(
                color: Colors.white,
          ...
          title: Text(AddedItemList.favouriteName[index]),
          subtitle: Text(AddedItemList.favouriteNumber[index]),
          trailing: Icon(
            Icons.favorite,
            color: Colors.amber,
          ),
